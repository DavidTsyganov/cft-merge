...
public class IntegerSorter {
    ...
    public IntegerSorter(final FileWriter fileWriter, final Comparator comparator) {
    ...
    public static <E extends Comparable<E>> File mergeTwoFiles(LineIterator iterator1,
        ...
        Integer value1 = iterator1.hasNext() ? Integer.valueOf(iterator1.next()) : null;
        Integer value2 = iterator2.hasNext() ? Integer.valueOf(iterator2.next()) : null;
